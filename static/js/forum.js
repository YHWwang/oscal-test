$(function () {
    ...
    var postType = {
        normal:'',
        3: '<svg t="1625109063701" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1178" width="20" height="20"><path d="M952 4.8 72 4.8c-40 0-72 32-72 72 0 40 32 72 72 72L952 148.8c40 0 72-32 72-72C1024 36.8 991.2 4.8 952 4.8L952 4.8zM952 4.8" fill="#1296db" p-id="1179"></path><path d="M564.8 223.2c-1.6-1.6-3.2-3.2-5.6-4.8-0.8-0.8-1.6-1.6-2.4-1.6-0.8-0.8-2.4-1.6-3.2-2.4-0.8-0.8-2.4-1.6-3.2-1.6-0.8-0.8-1.6-0.8-3.2-1.6-0.8-0.8-2.4-0.8-3.2-1.6C544 208 542.4 208 541.6 207.2c-0.8-0.8-2.4-0.8-3.2-0.8-0.8-0.8-2.4-0.8-3.2-1.6-0.8 0-2.4-0.8-3.2-0.8-0.8 0-2.4-0.8-3.2-0.8-1.6 0-2.4 0-4-0.8-0.8 0-2.4 0-3.2-0.8-2.4 0-4.8 0-7.2 0l0 0 0 0c0 0-0.8 0-0.8 0-18.4 0-37.6 6.4-52 20.8L97.6 586.4c-28 28-28 73.6 0 101.6 14.4 14.4 32.8 20.8 51.2 20.8 18.4 0 36.8-7.2 51.2-20.8l243.2-243.2 0 502.4c0 40 32 72 72 72 40 0 72-32 72-72L587.2 447.2 827.2 688c14.4 14.4 32.8 20.8 51.2 20.8s36.8-7.2 51.2-20.8c28-28 28-73.6 0-101.6L564.8 223.2 564.8 223.2zM564.8 223.2" fill="#1296db" p-id="1180"></path></svg>',
